...
#fungsi menyimpan data baru ke database
...
#fungsi membarui data di database
...
#fungsi menghitung prediksi data 
...
#fungsi untuk menghandle tombol delete 
def delete():
    try:
...
#fungsi mengisi kolom input dengan data dari database
...
#menyesuaikan posisi isi tabel di tengah
for col in columns:
